...
var (
	...
	ErrABFeeNegative               = errors.New("account-block fee can't be negative")
	ErrABFeeTooBig                 = errors.New("account-block fee is too big")
	ErrABFeeLessThanMin            = errors.New("account-block fee is less than min")
	ErrABAmountMustBeZero          = errors.New("account-block amount must be zero")
	ErrABFeeMustBeZero             = errors.New("account-block amount must be zero")
	...
	ErrMContentTooBigInSize     = errors.New("momentum content is too big in size")
